...
public partial class NorthwindContext : DbContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<CategorySalesFor1997>(entity => {
            ...
            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.CategorySales).HasColumnType("decimal(38, 2)");
        });
        ...
        modelBuilder.Entity<Invoice>(entity => {
            ...
            entity.Property(e => e.ExtendedPrice).HasColumnType("decimal(13, 2)");
        ...
        modelBuilder.Entity<ProductSalesFor1997>(entity => {
            ...
            entity.Property(e => e.CategoryName).HasMaxLength(15);
            entity.Property(e => e.ProductName).HasMaxLength(40);
            entity.Property(e => e.ProductSales).HasColumnType("decimal(38, 2)");
        });
        ...
        modelBuilder.Entity<SalesTotalsByAmount>(entity => {
            ...
            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.OrderId).HasColumnName("OrderID");
            entity.Property(e => e.SaleAmount).HasColumnType("decimal(38, 2)");
            entity.Property(e => e.ShippedDate).HasColumnType("datetime");
        });
